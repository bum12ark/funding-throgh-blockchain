...
<script type="text/javascript">
      ...
      function installDown(){
    	var term1 = document.getElementById("f_agree").Agree_cb1.checked;
      	var term2 = document.getElementById("f_agree").Agree_cb2.checked;
    	...
    	location.href="FTBC_download.jsp";
      	}
      }
      function generateKeys(){
         var mem_email= "a@naver.com";
         $.ajax({
            method:'get'
               ,url:'/restMember/generateKeys?mem_email='+ mem_email
	...
	<div class="container-fluid">
		...
		<div class="row" id="download_banner">
			...
			<div class="col-sm-4">
				<table width=960px align=center>
					<tr>
						<td align=>
							<!--이용약관 테이블 시작-->
							 <form id="f_agree" name="agree_download" onSubmit="agree_download()">
							<table width=550>
								<tr>
									<td>
										<div>
											<font color="#635c9f" size=4>01</font> <font size=3>이용약관</font>
										</div>
									</td>
								</tr>
								<tr>
									<td align=center><textarea name="tos" rows=10 cols=100>
제1조(목적)
 이 약관은 FTBC (전자상거래 사업자)가 운영하는 FTBC(이하 “몰”이라 한다)에서 제공하는 인터넷 관련
...
제24조(재판권 및 준거법)
 ...
 ②“몰”과 이용자간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
								...
								<tr>
									<td><input type="checkbox" name="Agree_cb1">이용약관에 동의합니다.<br>
									<br>
									<br>
									<br></td>
								</tr>
								<tr>
									<td>
										<div>
											<font color="#635c9f" size=4>02</font> <font size=3>개인정보
												수집 및 이용에 대한 안내</font>
										</div>
									</td>
								</tr>
								<tr>
									<td align=><textarea name="tos" rows=10 cols=100>
수집하는 개인정보의 항목
...
'정보통신망 이용촉진 및 정보보호 등에 관한 법률'의 거래기록 보존 의무에 따른 보존: 1년
								...
								<tr>
									<td><input type="checkbox" name="Agree_cb2">개인정보 수집 및 이용에 대한 안내에
										동의합니다.</td>
								</tr>
							</table>
							</form>
			...
			<div class="col-sm-3 " id="ExeDownLoad_page">
				<div id="imageBox">
					<img src="../FTBC_Images/exelogo.png" id="exelogo">
					<input type="button" class="WalletDown_btn" value="다운로드" onclick="installDown()">
				</div>
